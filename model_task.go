...
type Task struct {
	...
	TaskDefVersion NullableString `json:"task_def_version,omitempty"`
...
// GetTaskDefVersion returns the TaskDefVersion field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Task) GetTaskDefVersion() string {
	if o == nil || IsNil(o.TaskDefVersion.Get()) {
		var ret string
		return ret
	}
	return *o.TaskDefVersion.Get()
}

// GetTaskDefVersionOk returns a tuple with the TaskDefVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetTaskDefVersion gets a reference to the given NullableString and assigns it to the TaskDefVersion field.
func (o *Task) SetTaskDefVersion(v string) {
	o.TaskDefVersion.Set(&v)
}
// SetTaskDefVersionNil sets the value for TaskDefVersion to be an explicit nil
func (o *Task) SetTaskDefVersionNil() {
	o.TaskDefVersion.Set(nil)
}
...
func (o Task) ToMap() (map[string]interface{}, error) {
	...
	if o.TaskDefVersion.IsSet() {
		toSerialize["task_def_version"] = o.TaskDefVersion.Get()
	}
	if !IsNil(o.Input) {
