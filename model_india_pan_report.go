...
// checks if the IndiaPanReport type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IndiaPanReport{}

// IndiaPanReport struct for IndiaPanReport
type IndiaPanReport struct {
	...
	Breakdown *IndiaPanReportAllOfBreakdown `json:"breakdown,omitempty"`
	Properties *IndiaPanReportAllOfProperties `json:"properties,omitempty"`
}

type _IndiaPanReport IndiaPanReport
...
func (o *IndiaPanReport) GetBreakdown() IndiaPanReportAllOfBreakdown {
	if o == nil || IsNil(o.Breakdown) {
		var ret IndiaPanReportAllOfBreakdown
		return ret
	}
	return *o.Breakdown
}
...
// SetBreakdown gets a reference to the given IndiaPanReportAllOfBreakdown and assigns it to the Breakdown field.
...
func (o *IndiaPanReport) GetProperties() IndiaPanReportAllOfProperties {
	if o == nil || IsNil(o.Properties) {
		var ret IndiaPanReportAllOfProperties
		return ret
	}
	return *o.Properties
}
...
// SetProperties gets a reference to the given IndiaPanReportAllOfProperties and assigns it to the Properties field.
func (o *IndiaPanReport) SetProperties(v IndiaPanReportAllOfProperties) {
	o.Properties = &v
}

func (o IndiaPanReport) MarshalJSON() ([]byte, error) {
...
func (o IndiaPanReport) ToMap() (map[string]interface{}, error) {
...
func (o *IndiaPanReport) UnmarshalJSON(data []byte) (err error) {
	...
	varIndiaPanReport := _IndiaPanReport{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIndiaPanReport)

	if err != nil {
		return err
	}

	*o = IndiaPanReport(varIndiaPanReport)

	return err
}

type NullableIndiaPanReport struct {
	value *IndiaPanReport
	isSet bool
}

func (v NullableIndiaPanReport) Get() *IndiaPanReport {
	return v.value
}

func (v *NullableIndiaPanReport) Set(val *IndiaPanReport) {
	v.value = val
	v.isSet = true
}

func (v NullableIndiaPanReport) IsSet() bool {
	return v.isSet
}

func (v *NullableIndiaPanReport) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIndiaPanReport(val *IndiaPanReport) *NullableIndiaPanReport {
	return &NullableIndiaPanReport{value: val, isSet: true}
}

func (v NullableIndiaPanReport) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIndiaPanReport) UnmarshalJSON(src []byte) error {
	v.isSet = true
