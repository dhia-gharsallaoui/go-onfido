...
type FacialSimilarityPhotoReport struct {
	...
	Properties *FacialSimilarityPhotoProperties `json:"properties,omitempty"`
}
...
func (o *FacialSimilarityPhotoReport) GetProperties() FacialSimilarityPhotoProperties {
	if o == nil || IsNil(o.Properties) {
		var ret FacialSimilarityPhotoProperties
		return ret
	}
	return *o.Properties
}
...
// SetProperties gets a reference to the given FacialSimilarityPhotoProperties and assigns it to the Properties field.
