...
// ReportStatus The current state of the report in the checking process. Read-only.
type ReportStatus string

// List of report_status
const (
	AWAITING_DATA ReportStatus = "awaiting_data"
	AWAITING_APPROVAL ReportStatus = "awaiting_approval"
...
// Ptr returns reference to report_status value
