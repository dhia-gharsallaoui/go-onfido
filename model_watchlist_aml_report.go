...
// checks if the WatchlistAmlReport type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WatchlistAmlReport{}

// WatchlistAmlReport struct for WatchlistAmlReport
type WatchlistAmlReport struct {
	...
	Breakdown *WatchlistAmlBreakdown `json:"breakdown,omitempty"`
	Properties *WatchlistAmlProperties `json:"properties,omitempty"`
}

type _WatchlistAmlReport WatchlistAmlReport
...
// SetBreakdown gets a reference to the given WatchlistAmlBreakdown and assigns it to the Breakdown field.
...
func (o *WatchlistAmlReport) GetProperties() WatchlistAmlProperties {
	if o == nil || IsNil(o.Properties) {
		var ret WatchlistAmlProperties
		return ret
	}
	return *o.Properties
}
...
// SetProperties gets a reference to the given WatchlistAmlProperties and assigns it to the Properties field.
func (o *WatchlistAmlReport) SetProperties(v WatchlistAmlProperties) {
	o.Properties = &v
}

func (o WatchlistAmlReport) MarshalJSON() ([]byte, error) {
...
func (o WatchlistAmlReport) ToMap() (map[string]interface{}, error) {
...
func (o *WatchlistAmlReport) UnmarshalJSON(data []byte) (err error) {
	...
	varWatchlistAmlReport := _WatchlistAmlReport{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWatchlistAmlReport)

	if err != nil {
		return err
	}

	*o = WatchlistAmlReport(varWatchlistAmlReport)

	return err
}

type NullableWatchlistAmlReport struct {
	value *WatchlistAmlReport
	isSet bool
}

func (v NullableWatchlistAmlReport) Get() *WatchlistAmlReport {
	return v.value
}

func (v *NullableWatchlistAmlReport) Set(val *WatchlistAmlReport) {
	v.value = val
	v.isSet = true
}

func (v NullableWatchlistAmlReport) IsSet() bool {
	return v.isSet
}

func (v *NullableWatchlistAmlReport) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWatchlistAmlReport(val *WatchlistAmlReport) *NullableWatchlistAmlReport {
	return &NullableWatchlistAmlReport{value: val, isSet: true}
}

func (v NullableWatchlistAmlReport) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWatchlistAmlReport) UnmarshalJSON(src []byte) error {
	v.isSet = true
